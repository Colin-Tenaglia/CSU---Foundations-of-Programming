...
1. Confirm the residence (Brookfield, Waukesha County, Wisconsin) and the executor succession (Anthony, then Andrew, then David) are correct. The Fidelity Account is identified by registration type and the last four digits of its number; your attorney may prefer the full number on the signed copy.
6. Your Fidelity retirement accounts (Traditional IRA, Roth IRA, and the two inherited BDA IRAs) and your Health Savings Account pass by beneficiary designation, not under this will. If David is named as beneficiary on any of them, that property counts toward his 50% under Section 3.4. Review those designations so they match your intent. Your Cash Management account has no TOD designation and will pass under this will as part of the Net Estate.
